...
"""
# COMENTARIO GLOBAL Para quitar Unamed del dataframe .loc[:, ~df.columns.str.contains('^Unnamed')]
...
def calcular_vectores_valores_eigen(valores_eigen, n_dimension):
    ...
    # vectores_valores_eigen.T.to_csv('csv/vectores_valores_eigen.csv')  # Por si se deseara cargar los vectores a un archivo csv
...
def main():
    ...
    regiones = region.cargar_regiones()  # 20000000
