...
def main():
    ...
    # NOTA GENERAL para el main se puede calcular la matriz completa y se recortan los datos al momento de llamar la pruebaMatricesCuadradasAcoplamiento   matrices_acomplamiento_int.loc[:,0:5]
