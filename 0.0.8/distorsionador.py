...
def cargar_integrandos_vectores_distorsionadores():
    ...
    """
    integrandos_vectores_distorsionadores = pd.read_csv("csv/vectores_distorsionadores.csv")
...
def main():
    ...
    integrandos_vectores_distorsionadores = cargar_integrandos_vectores_distorsionadores()
    print(integrandos_vectores_distorsionadores.to_string())
    vectores_distorsionadores_int = calcular_vectores_distorsionadores_integral(integrandos_vectores_distorsionadores, vectores_valores_eigen, n_dimension)
    vectores_distorsionadores_sol = calcular_vectores_distorsionadores_solucion(integrandos_vectores_distorsionadores, vectores_valores_eigen, n_dimension)
    print(f"\n\t\tVectores distorsionadores: solucion con quad\n\n{vectores_distorsionadores_int}")
    print(f"\n\t\tVectores distorsionadores: solucion analitica\n\n{vectores_distorsionadores_sol}")
    print(f"\n\tDiferencia entre la solucion analitica y la integral\n\n{vectores_distorsionadores_int - vectores_distorsionadores_sol}")
    # print(vectores_distorsionadores_int.loc['S1'][:5])
