...
def cargar_recursos_flujo(regiones, ejes_relativos):
    ...
    recursos_flujo.loc[regiones['direcc_de_flujo']=='subiendo','signo'] = '0+'
    recursos_flujo.loc[regiones['direcc_de_flujo']=='bajando','signo'] = '0-'
    recursos_flujo.loc[regiones['direcc_de_flujo']=='ambos sentidos','signo'] = '0+'
    # Se construye el factor normalizador 1
    ...
    # Se construye el factor normalizador 2
    ...
    (recursos_flujo.loc[u'\u2202V1', 'signo']).replace
...
def calcular_flujos(regiones, ejes_relativos, mesh_regiones, vectores_valores_eigen,\
    ...
    for n_flujo in flujos.index:
        ...
        for i in range(0, n_dimension):
            ...
            flujos.loc[n_flujo, i] = recursos_flujo.loc[n_flujo, 'signo'] + vector_transpuesto @ (factor_normalizador_1 @ C1 + factor_normalizador_2 @ C2)
