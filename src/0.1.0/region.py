...
def cargar_mesh_regiones(regiones, n_dimension=100, delta=10):
    ...
    for reg in regiones.index:
        ...
        x = x.reshape(1,delta*delta)
        y = y.reshape(1,delta*delta)
        # Se reajustan los vectores hasta n_dimension
        x = x[0][0:n_dimension]
        y = y[0][0:n_dimension]
...
def main():
    ...
    mesh_regiones = cargar_mesh_regiones(regiones, n_dimension, delta=5)
    ...
    print(mesh_regiones)
    print("\n\t\t\tMeshgrid de Region.1 desde 0 hasta 15")
