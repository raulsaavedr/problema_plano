...
logger.setLevel(logging.INFO)#conf.get_logging_level('matriz_gauss'))
...
def main():
    ...
    regiones = reg.cargar_regiones(n_dimension=100)#n_dimension=input("Inserte dimension del problema plano:"))
